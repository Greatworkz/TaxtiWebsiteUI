...
═══════════════════════════════════════════════════════════
      ...
      emailFormData.append("subject", `Disneyland Tour Booking - ${formData.firstName} ${formData.lastName} - ${formData.pickupDate}`);
      ...
      <section className="quote-section container">
        <div className="quote-grid">
          ...
          <div className="quote-card">
            {/* Step Indicator */}
            <div style={{ marginBottom: '20px', textAlign: 'center', fontSize: '16px', fontWeight: 'bold' }}>
            ...
            <div className="fare-row">
              <span>Total Fare : <br/>
              <strong>{formData.totalFare} €</strong> </span>
